...
module.exports.run = async (client, message, args) => {
    ...
    if (!message.guild.members.cache.get(message.author).permissions.has('KICK_MEMBERS')) {return message.channel.send("Vous n'avez pas la permission de faire cette commande !"); }
    ...
    message.guild.members.cache.get(user).kick(reason)
};
